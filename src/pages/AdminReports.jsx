...
export default function AdminReports() {
  ...
  if (!data) return <div className="alert">Carregando relatorios...</div>;
      ...
      <section className="admin-card admin-panel-card">
        <div className="admin-section-head">
          <div>
            ...
            <h2>Relatorios e auditoria</h2>
            <p>Acompanhe funil, trafego real, interesse por lote e o comportamento da base.</p>
          </div>
        </div>

        <div className="stats report-stats-grid">
          <div className="stat-card"><span>Total usuarios</span><strong>{data.total_users}</strong></div>
          ...
          <div className="stat-card"><span>Usuarios com lance</span><strong>{data.users_with_bids}</strong></div>
          <div className="stat-card"><span>Total leiloes</span><strong>{data.total_auctions}</strong></div>
      ...
      <div className="reports-dashboard-grid">
        <section className="admin-card admin-panel-card report-dashboard-card report-dashboard-card--funnel report-card-accent">
          ...
          <div className="report-funnel-list">
            ...
            <div><span>Usuarios com lance</span><strong>{data.funnel.usuarios_com_lance}</strong></div>
          </div>
        </section>
        ...
        <section className="admin-card admin-panel-card report-dashboard-card report-dashboard-card--traffic">
          <div className="report-card-head">
            <div>
              <span className="admin-kicker">Trafego</span>
              <h2>Origem das visitas</h2>
            </div>
          </div>
          <div className="table admin-table-pro">
            <div><span>Origem</span><span>Total</span><span>Participacao</span></div>
        ...
        <section className="admin-card admin-panel-card report-dashboard-card report-dashboard-card--interest">
          <div className="report-card-head">
            <div>
              ...
              <h2>Leiloes com maior procura</h2>
            </div>
          </div>
          <div className="table admin-table-pro">
        ...
        <section className="admin-card admin-panel-card report-dashboard-card report-dashboard-card--bids">
          <div className="report-card-head">
            <div>
              <span className="admin-kicker">Ultima atividade</span>
